...
public class AnalogAbsoluteConfiguration {
    ...
    public AnalogAbsoluteConfiguration(int id, double offset, String canbus, SensorInitializationStrategy initStrategy) {
        this.id = id;
        this.offset = offset;
        this.canbus = canbus;
    ...
    public AnalogAbsoluteConfiguration(int id, double offset, String canbus) {
